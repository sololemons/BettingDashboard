...
const marketChartOptions = {
  ...
  scales: {
    ...
    y: {
      title: { display: true, text: "Number of Betslips" },
      beginAtZero: true,
    },
  },
};
...
<template>
  <div
    class="w-full border border-gray-200 px-10 rounded-2xl shadow-md bg-white p-6"
  >
    <div class="mb-4">
