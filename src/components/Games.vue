<template>
    ...
    <div v-if="loading">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div v-for="match in matches" :key="match.matchId" class="bg-white shadow-lg rounded-lg p-6 hover:shadow-xl transition">
          ...
          <div v-for="market in match.markets" :key="market.marketId" class="mt-4">
            ...
            <div class="flex gap-2 mt-2">
              <button
                ...
                :key="odd.oddsId"
                class="bg-green-500 text-white px-4 py-2 rounded-lg shadow-md hover:bg-green-600 transition w-full text-center"
              >
