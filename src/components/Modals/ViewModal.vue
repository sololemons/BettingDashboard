    ...
    <div class="p-6 bg-white shadow-md rounded-lg">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full border border-gray-300 rounded-lg">
                ...
                <tbody>
                    <tr v-for="admin in admins" :key="admin.phoneNumber" class="border-b hover:bg-gray-50">
                        ...
                        <td class="p-3">
                            <button @click="deleteAdmin(admin.adminId)" class="text-red-500 hover:text-red-700">
                                <p>delete</p>
                            </button>
                        </td>
                    </tr>
